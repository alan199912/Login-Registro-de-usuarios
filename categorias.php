...
<?php
    ...
    $categoria_seleccionada = categoriaSeleccionada($db, $_GET['id']);
    
    if(!isset($categoria_seleccionada['id'])) {
...
<div class="container mt-5">
     ...
     <div class="row">
        ...
        <div class="col-8 mb-4">
             ...
             <div class="card ">
             <h1 class="text-center mt-3">Entradas <?=$categoria_seleccionada['nombre']?></h1>
